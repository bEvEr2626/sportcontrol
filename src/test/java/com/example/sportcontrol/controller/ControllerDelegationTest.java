...
class ControllerDelegationTest {
    ...
    void asyncLoadDemoControllerDelegatesAsyncOperations() {
        ...
        ResponseEntity<AsyncTaskAcceptedResponseDto> acceptedResult = asyncLoadDemoController.startTask(5000L);
        ResponseEntity<AsyncTaskStatusDto> statusResult = asyncLoadDemoController.getTaskStatus("demo-task");
